	...
	for (var b=0; b<gvg.background_maps.length; b++) {
		...
		if (!mapinfo.url) {
			...
			if (mapinfo.style) { // unless it's a styled map
				...
				var max_zoom = (mapinfo.max_zoom) ? mapinfo.max_zoom : 20;
				var map_properties = {
...
function GV_Utilities_Button() {
	...
	utilities_button.innerHTML = '<img src="'+gvg.icon_directory+'images/utilities_button.png" width="24" height="20" border="0" onclick="GV_Utilities_Menu(true);" style="cursor:pointer;" title="click here for map utilities" />';
...
function GV_Background_Map_List() {
	return [	
		...
		,{ id:'US_COUNTIES_OSM', menu_order:13.21, menu_name:'US counties+OSM', description:'United States county outlines', credit:'US Counties from <a target="_blank" href="https://tigerweb.geo.census.gov/tigerwebmain/TIGERweb_main.html">US Census Bureau</a>', error_message:'TIGERweb tiles unavailable', min_zoom:6, max_zoom:13, country:'us', bounds:[-169,18,-66,72], bounds_subtract:[-129,49.5,-66,72], tile_size:256, url:['http://otile1.mqcdn.com/tiles/1.0.0/map/{Z}/{X}/{Y}.jpg','https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?service=WMS&request=GetMap&version=1.1.1&format=image/png&transparent=true&exceptions=application/vnd.ogc.se_inimage&srs=EPSG:4326&styles=&layers=Counties'], opacity:[0.5,1] }
		,{ id:'US_STATES', menu_order:13.3, menu_name:'US state outlines', description:'United States state outlines', credit:'US States from <a target="_blank" href="http://nationalmap.gov/">The National Map</a>', error_message:'National Map unavailable', min_zoom:4, max_zoom:12, country:'us', bounds:[-169,18,-66,72], bounds_subtract:[-129,49.5,-66,72], tile_size:128, url:'http://services.nationalmap.gov/arcgis/services/SmallScale1Million/SmallScaleBoundariesWMS/MapServer/WMSServer?service=WMS&request=GetMap&version=1.1.1&request=GetMap&format=image/png&transparent=false&srs=EPSG:4326&layers=15&styles=' }
...
function GV_Define_Styles() {
	...
	document.writeln('			.gv_label { background-color:#333333; border:1px solid black; padding:1px; text-align:left; white-space: nowrap; font:9px Verdana,sans-serif; color:white; }');
