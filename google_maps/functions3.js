...
function GV_Define_Vector_Icons() {
	gvg.icons['airport'].vector = '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="17px" height="17px" viewBox="0 0 17 17"><polygon opacity="1" fill="white" points="11,17 17,11 17,6 11,0 6,0 0,6 0,11 6,17 "/><path opacity="1" fill="#ffffff" stroke="black" stroke-width="1" d="M8.5,15.171l-2.614,0.404v-1.921L7.5,12.96V9.39l-6.846,1.176V8.553L7.5,5.821V1.334 c0-0.464,0.56-0.831,1-0.831s1,0.367,1,0.831v4.487l6.846,2.732v2.013L9.5,9.39v3.57l1.614,0.694v1.921L8.5,15.171z"/></svg>';
	...
	gvg.icons['cross'].vector = '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="13px" height="13px" viewBox="0 0 13 13"><polygon opacity="1" fill="white" stroke="black" stroke-width="1" points="4.5,0.5 8.5,0.5 8.5,4.5 12.5,4.5 12.5,8.5 8.5,8.5 8.5,12.5 4.5,12.5 4.5,8.5 0.5,8.5 0.5,4.5 4.5,4.5 "/></svg>';
	gvg.icons['diamond'].vector = '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="13px" height="13px" viewBox="0 0 13 13"><path opacity="1" fill="white" stroke="black" stroke-width="1" d="M6.5,0c0,2.364-4.136,6.5-6.5,6.5c2.364,0,6.5,4.137,6.5,6.5 c0-2.363,4.137-6.5,6.5-6.5C10.637,6.5,6.5,2.364,6.5,0z"/></svg>';
	...
	gvg.icons['square'].vector = '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="11px" height="11px" viewBox="0 0 11 11"><rect opacity="1" fill="white" stroke="black" stroke-width="1" x="1.5" y="1.5" width="8" height="8"/></svg>';
	gvg.icons['star'].vector = '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="19px" height="19px" viewBox="0 0 19 19"><polygon opacity="1" fill="white" stroke="black" stroke-width="1" points="9.5,1.771 11.361,7.5 17.385,7.5 12.512,11.04 14.374,16.769 9.5,13.229 4.626,16.769 6.488,11.04 1.615,7.5 7.639,7.5 "/></svg>';
	gvg.icons['triangle'].vector = '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="13px" height="13px" viewBox="0 0 13 13"><polygon opacity="1" fill="white" stroke="black" stroke-width="1" points="0.866,10.758 6.5,1 12.134,10.758" /></svg>';
	gvg.icons['tickmark'].vector = '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="13px" height="13px" viewBox="0 0 13 13"><polygon fill="white" stroke="black" points="10.5,6.5 6.5,2.5 2.5,6.5 6.5,10.5 "/></svg>';
	gvg.icons['tickmark-r'] = {vector:'<svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="13px" height="13px" viewBox="0 0 13 13"><polygon fill="white" stroke="black" transform="rotate(0 6.5 6.5)" points="11.75,8.5 6.5,3.5 1.25,8.5 "/></svg>'};
	...
	gvg.icons['tickmark'].shadow = 'data:image/png;base64,';
